...
func request_ProjectService_Get_0(ctx context.Context, marshaler runtime.Marshaler, client ProjectServiceClient, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
	var protoReq OneProjectRequest
	var metadata runtime.ServerMetadata
...
var (
	pattern_ProjectService_Create_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 1, 0, 4, 1, 5, 2, 2, 3}, []string{"go", "company", "company_id", "project"}, "", runtime.AssumeColonVerbOpt(true)))

	pattern_ProjectService_Update_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 1, 0, 4, 1, 5, 2}, []string{"go", "project", "id"}, "", runtime.AssumeColonVerbOpt(true)))

	pattern_ProjectService_Get_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 1, 0, 4, 1, 5, 2}, []string{"go", "project", "id"}, "", runtime.AssumeColonVerbOpt(true)))

	pattern_ProjectService_List_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1}, []string{"go", "projects"}, "", runtime.AssumeColonVerbOpt(true)))

	pattern_ProjectService_Delete_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 1, 0, 4, 1, 5, 2}, []string{"go", "project", "id"}, "", runtime.AssumeColonVerbOpt(true)))
)
