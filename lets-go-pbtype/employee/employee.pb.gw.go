...
var (
	...
	pattern_EmployeeService_Update_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 1, 0, 4, 1, 5, 2}, []string{"go", "employee", "id"}, "", runtime.AssumeColonVerbOpt(true)))

	pattern_EmployeeService_Get_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 1, 0, 4, 1, 5, 2}, []string{"go", "employee", "id"}, "", runtime.AssumeColonVerbOpt(true)))

	pattern_EmployeeService_List_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1}, []string{"go", "employees"}, "", runtime.AssumeColonVerbOpt(true)))

	pattern_EmployeeService_Delete_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 1, 0, 4, 1, 5, 2}, []string{"go", "employee", "id"}, "", runtime.AssumeColonVerbOpt(true)))
)
