...
/*
Package employee_project is a reverse proxy.
...
var (
	filter_EmployeeService_Delete_0 = &utilities.DoubleArray{Encoding: map[string]int{"project_id": 0, "employee_id": 1}, Base: []int{1, 1, 2, 0, 0}, Check: []int{0, 1, 1, 2, 3}}
)
...
func request_EmployeeService_Delete_0(ctx context.Context, marshaler runtime.Marshaler, client EmployeeServiceClient, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
	...
	if err := runtime.PopulateQueryParameters(&protoReq, req.Form, filter_EmployeeService_Delete_0); err != nil {
		return nil, metadata, status.Errorf(codes.InvalidArgument, "%v", err)
	}
...
var (
	pattern_EmployeeService_Create_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 1, 0, 4, 1, 5, 2, 2, 3, 1, 0, 4, 1, 5, 4}, []string{"go", "project", "project_id", "employee", "employee_id"}, "", runtime.AssumeColonVerbOpt(true)))

	pattern_EmployeeService_Delete_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 1, 0, 4, 1, 5, 2, 2, 3, 1, 0, 4, 1, 5, 4}, []string{"go", "project", "project_id", "employee", "employee_id"}, "", runtime.AssumeColonVerbOpt(true)))
)
